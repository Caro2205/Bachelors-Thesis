...
def create_folders(curr_time):
    ...
    folderdir = "./model_runs/" + foldername + "/"  # this run in general run folder
...
################################### parameters have to be set here #####################################################
    ...
    # Paths for datasets
    datapath = './training_data/data_dataset_1.txt'  # data used for training (model input)
    targetpath = './training_data/target_dataset_1.txt'  # can be None     # data used for training (desired model output)

    test_datapath = './training_data/testing_data.txt'  # data used to see how the model performs on that data after certain training epochs
    test_targetpath = './training_data/testing_target.txt'
